        ...
        for n in range(10):
            ...
            for i in range(num_batch):
                ...
                if (n*num_batch+i) % 100 == 0:
                    ...
                    saver.save(sess, './model_two/train_faces.model', global_step=n*num_batch+i)
